  ...
  withAuthorization(
    async (authorizedRequest, { params }) => {
      try {
        ...
        const result = await transitionMilestoneStatus(db, milestoneId, "submitted", {
        ...
        console.error("[api/milestones/submit] POST error:", err);
        return NextResponse.json({ error: "Server error" }, { status: 500 });
      }
    },
    {},
  ),
  { route: "milestone_submit", rateLimit: { limit: 30, windowMs: 60_000 } },
);
